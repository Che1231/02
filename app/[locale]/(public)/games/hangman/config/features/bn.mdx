...
<img alt="হ্যাংম্যান" class="w-4/5 h-auto" src="/game-covers/hangman.svg" />
</div>
</div>
...
<img alt="হ্যাংম্যান গেমপ্লে" class="w-4/5 h-auto mx-auto" src="/game-covers/hangman.svg" />
</div>
...
জেনে নিন!
  ...
  <div class="w-full md:w-1/2 flex justify-center items-center">
<img alt="হ্যাংম্যান স্ক্রিনশট" class="w-4/5 h-auto" src="/game-covers/hangman.svg" />
</div>
</div>